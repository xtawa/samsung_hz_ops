...
class PreferencesRepository(private val context: Context) {
    ...
    val automationEnabled: Flow<Boolean> = context.hzOpsDataStore.data.map { it[Keys.automationEnabled] ?: false }
    val psmHighRefreshEnabled: Flow<Boolean> = context.hzOpsDataStore.data.map { it[Keys.psmHighRefreshEnabled] ?: false }
    val quickDozeEnabled: Flow<Boolean> = context.hzOpsDataStore.data.map { it[Keys.quickDozeEnabled] ?: false }
    val batteryProtectEnabled: Flow<Boolean> = context.hzOpsDataStore.data.map { it[Keys.batteryProtectEnabled] ?: false }
    val networkSpeedEnabled: Flow<Boolean> = context.hzOpsDataStore.data.map { it[Keys.networkSpeedEnabled] ?: false }
    val sensorsOffEnabled: Flow<Boolean> = context.hzOpsDataStore.data.map { it[Keys.sensorsOffEnabled] ?: false }
